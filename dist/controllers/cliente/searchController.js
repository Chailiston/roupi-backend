...
async function searchProducts(req, res) {
    try {
        ...
        const params = [];
        let whereClauses = ['p.ativo = true', 'l.ativo = true'];
        let orderByClause = '';
        ...
        switch (sort) {
            case 'price_asc':
                orderByClause = 'ORDER BY preco_atual ASC';
                break;
            case 'price_desc':
                orderByClause = 'ORDER BY preco_atual DESC';
                break;
            case 'rating':
                orderByClause = 'ORDER BY rating_avg DESC, p.nome ASC';
                break;
            case 'distance':
