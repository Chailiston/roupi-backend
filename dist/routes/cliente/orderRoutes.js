...
router.get('/', authMiddleware_1.authMiddleware, orderController_1.listOrders);
...
router.get('/:id', authMiddleware_1.authMiddleware, orderController_1.getOrderDetails);
