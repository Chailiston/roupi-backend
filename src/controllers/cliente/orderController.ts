// src/controllers/cliente/orderController.ts
...
export const listOrders = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const { rows } = await pool.query(ordersQuery, [clienteId]);
...
export const getOrderDetails = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const orderResult = await pool.query(orderDetailsQuery, [pedidoId, clienteId]);
        ...
        const itemsResult = await pool.query(orderItemsQuery, [pedidoId]);
